...
const About = () => {
  return (
    <div id='about' className=' py-16'>
        ...
        <section className=' w-[35%] max-tablet:w-[70%] max-tablet:mt-[30px] '>
            <p className=' text-[40px]'>A <AnimatedText/></p>
            <p className=' font-serif text-[17px]'>I'm Gbadamosi Blessing, a passionate and creative Frontend Developer dedicated to building modern, responsive, and user-friendly web applications. With a strong focus on clean design and functionality, I enjoy turning complex problems into simple, beautiful interfaces.
