...
const Home = () => {
  return (
    <div id='home' className=' relative min-h-screen pt-60 bg-[url("/img1.jpg")]  bg-center bg-cover max-tablet:pt-65 max-mobile:pt-70   '>
          ...
          <div className=' flex flex-col px-30 justify-center gap-3 z-10 relative h-full max-tablet:pl-20 max-mobile:pl-10 max-w-[1020px]'>
        ...
        <div className=' flex items-center gap-5 max-mobile:gap-2'>
          <a href="#contact"> <button  className=' bg-[#074188] p-3 rounded-md text-[23px] font-medium text-white max-mobile:text-[16px] max-mobile:p-2 '>Contact Me</button>  </a>
